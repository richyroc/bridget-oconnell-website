...
if(isset($_POST['submitcontact']))
{
	...
	$subject = "Bridget, You have a new Subscriber";
	$message = " Name: " . $name ."\r\n Email: " . $email . "\r\n Message:\r\n" . $message;
	 
	$from = "Bridget O'Connell Website";
	$headers = "From:" . $from . "\r\n";
					...
					<div class="col-2-3">
						...
						<div id='cssmenu' class="align-right">
							<ul>
							   ...
							   <li><a href='archive.html'><span>About Bridget</span></a></li>
							   <li class="active"><a href='contact.html'><span>Contact Me</span></a></li>
							</ul>
						</div>
					</div>
				</div>
